...
func TestAuthMiddleware_UninitializedDependencies(t *testing.T) {
	...
	tokenExtractor, err := NewTokenExtractor("https://localhost:8090/oauth2/jwks", "https://localhost:8090/oauth2/token", []string{"TRADER_PORTAL_APP"}, []string{"TRADER_PORTAL_APP"})
	if err != nil {
