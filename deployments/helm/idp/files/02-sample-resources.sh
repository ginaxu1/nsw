...
SAMPLE_USER_PASSWORD="${THUNDER_SAMPLE_USER_PASSWORD:?THUNDER_SAMPLE_USER_PASSWORD environment variable is required}"
...
M2M_CLIENT_SECRET="${THUNDER_M2M_CLIENT_SECRET:?THUNDER_M2M_CLIENT_SECRET environment variable is required}"
...
RESPONSE=$(thunder_api_call POST "/user-types" "${PRIVATE_USER_TYPE_PAYLOAD}")
HTTP_CODE="${RESPONSE: -3}"
...
RESPONSE=$(thunder_api_call POST "/user-types" "${GOVERNMENT_USER_TYPE_PAYLOAD}")
HTTP_CODE="${RESPONSE: -3}"
